...
Route::group([
    ...
    Route::get('/redirect', [GoogleOAuthController::class, 'redirectToGoogle'])->name('auth.google.redirect');
    Route::get('/callback', [GoogleOAuthController::class, 'handleCallback'])->name('auth.google.callback');
});
...
Route::prefix('/articles')->group(function () {
    Route::middleware('auth')->group(function () {
        ...
        Route::get('/write', [ArticleController::class, 'create'])->name('article.create');
