        ...
        <main class="px-3 xl:px-0 max-w-6xl pt-3 w-full">
            ...
            <form action="" method="POST" enctype="multipart/form-data" class="flex flex-col space-y-4">
                ...
                <div class="flex flex-col">
                    ...
                    <input type="text" name="title" id="title" placeholder="Title" class="rounded border max-w-xl py-2 px-3 leading-tight focus:outline-none focus:shadow-outline" required>
                </div>
                <div class="flex flex-col">
                    <label class="font-bold" for="title">Image</label>
                    <input type="file" name="image" id="image" class="rounded max-w-xl py-2" required>
                </div>
                <div class="flex flex-col">
                    <label class="font-bold" for="content">Content</label>
                    <textarea name="content" id="content" cols="30" rows="10" class="rounded border py-2 px-3 leading-tight focus:outline-none focus:shadow-outline"></textarea>
                </div>
                <div class="flex">
